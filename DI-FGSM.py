...
if __name__ == '__main__':
    ...
    parameters = {'attack': 'DI-FGSM', **vars(args)}
    experiment.log_parameters(parameters)
    experiment.set_name("DI-FGSM_"+args.model+"_"+args.target)
    ...
    for batch_ndx, (x_test, y_test) in enumerate(loader):
        ...
        print('Running DI-FGSM attack on batch ', batch_ndx)
        ...
        if correct_batch_indices.size(0) != 0:
            ...
            for idx in correct_batch_indices:
                ...
                if torch.argmax(target_model(adv_images_DI[idx].unsqueeze(0))) != y_test[idx]:
